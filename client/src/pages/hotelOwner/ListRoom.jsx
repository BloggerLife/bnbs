  ...
  return (
    <div>
      <Title
        align="left"
        font="outfit"
        title="Place Listings"
        subTitle="View, edit, or manage all listed Places. Keep the information up-to-date to provide the best experience for users."
      />
      <p className="text-gray-500 mt-8">Total Places</p>
